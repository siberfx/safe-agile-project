...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Edit Business Goal</h1>
            <p class="text-gray-600 mt-2">Update business goal information and settings</p>
        </div>
        <div class="flex items-center space-x-4">
            <a href="{{ route('admin.access.business-goals.show', $businessGoal->id) }}" class="px-4 py-2 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Update the strategic objective and its parameters</p>
                </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <p class="text-sm text-gray-900">{{ $businessGoal->created_at->format('d-m-Y H:i') }}</p>
                    </div>
                    <div>
                        <label class="text-sm font-medium text-gray-500">Last Updated</label>
                        <p class="text-sm text-gray-900">{{ $businessGoal->updated_at->format('d-m-Y H:i') }}</p>
                    </div>
                    <div>
                        <label class="text-sm font-medium text-gray-500">Program</label>
                        <p class="text-sm text-gray-900">{{ $businessGoal->program->title ?? 'No program' }}</p>
                    </div>
                    <div>
                        <label class="text-sm font-medium text-gray-500">Epics</label>
                        <p class="text-sm text-gray-900">{{ $businessGoal->epics->count() }} epics</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-2">
                    <a href="{{ route('admin.access.business-goals.show', $businessGoal->id) }}" class="w-full bg-gray-100 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200 text-center block">
                        <i class="fas fa-eye mr-2"></i>
                        View Goal
                    </a>
