...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Create New Epic</h1>
            <p class="text-gray-600 mt-2">Define a large-scale initiative or capability for your business goal</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Define the epic and its parameters</p>
                </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">Creating an Epic</h3>
                <div class="space-y-3 text-sm text-gray-600">
                    <div class="flex items-start">
                        <i class="fas fa-lightbulb text-yellow-500 mt-1 mr-2"></i>
                        <p>Epics are large-scale initiatives that break down into smaller features and user stories.</p>
                    </div>
                    <div class="flex items-start">
                    ...
                    <div class="flex items-start">
                        ...
                        <p>Expected value helps measure the business impact and ROI of the epic.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-2">
                    <a href="{{ route('admin.access.epics.index') }}" class="w-full bg-gray-100 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200 text-center block">
