...
@section('title', 'Create Project - Programma Portaal')
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 mt-2">Define a new project to organize your work</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Define the project and its parameters</p>
                </div>
        
                <form action="{{ route('admin.access.projects.store') }}" method="POST" class="p-6 space-y-6">
                    @csrf
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <h2 class="text-lg font-semibold text-gray-900 mb-4">Creating a Project</h2>
                <div class="space-y-3 text-sm text-gray-600">
                    <div class="flex items-start">
                        <i class="fas fa-info-circle text-primary mt-0.5 mr-2"></i>
                        <span>Projects can be independent or part of a Program</span>
                    </div>
                    <div class="flex items-start">
                        <i class="fas fa-calendar text-primary mt-0.5 mr-2"></i>
                        <span>Set realistic start and end dates</span>
                    </div>
                    <div class="flex items-start">
                        <i class="fas fa-user text-primary mt-0.5 mr-2"></i>
                        <span>Assign a creator for accountability</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-2">
                    <a href="{{ route('admin.access.projects.index') }}" class="w-full bg-gray-100 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200 text-center block">
                    ...
                    <a href="{{ route('admin.access.programs.index') }}" class="w-full bg-gray-100 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200 text-center block">
                        <i class="fas fa-folder mr-2"></i>Manage Programs
                    </a>
                </div>
            </div>
        </div>
